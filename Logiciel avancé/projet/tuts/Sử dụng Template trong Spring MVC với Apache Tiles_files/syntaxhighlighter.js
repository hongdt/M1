...
;(function()
{
  ...
  function Brush()
  {
     // http://stackoverflow.com/questions/11670373/pygments-lexer-for-aspectj
     var keywords =   'abstract assert boolean break byte case catch char class const ' +
                 'continue default do double else enum extends ' +
                 'false final finally float for goto if implements import ' +
                 'instanceof int interface long native new null ' +
  ...
  Brush.prototype   = new SyntaxHighlighter.Highlighter();
  Brush.aliases   = ['aspectj'];

  SyntaxHighlighter.brushes.AspectJ = Brush;
...
;(function()
{
    ...
    function Brush()
    {
        var keywords =    'associatedtype class deinit enum extension func import init inout internal let operator private protocol public static struct subscript typealias var '+
