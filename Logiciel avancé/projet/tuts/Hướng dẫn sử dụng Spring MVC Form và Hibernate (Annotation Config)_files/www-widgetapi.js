...
I.prototype.c=!1;I.prototype.isDisposed=function(){return this.c};
I.prototype.dispose=function(){this.c||(this.c=!0,this.A())};
...
g.A=function(){J.D.A.call(this);this.clear();this.g.length=0};var Za=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#(.*))?$/;function $a(a,b,c){if("array"==n(b))for(var d=0;d<b.length;d++)$a(a,String(b[d]),c);else null!=b&&c.push("&",a,""===b?"":"=",encodeURIComponent(String(b)))}
...
g.l=function(a,b){if(!this.f.isDisposed()){var c={target:this,data:b};this.f.I(a,c);ub(this.m+"."+a,c)}};
