  ...
  <li class="sale">
                ...
                <li class="move">
                 <span class="menu-title" id="title_demenager" style="position:relative; left:45px; top:-5px"><a href="alerter.jsp"><img src="CSS/icon.png"></a><span class="pic"><span></span></span></span>
                      ...
                      <li class="move">
                 <span class="menu-title" id="title_demenager" style="font-size:20px; left:30px"><a href="#">déconnexion</a><span class="pic"><span></span></span></span>
...
<div class="container-ep">
    ...
    <div class="block-account" style="">
        ...
        <div class="block-name">
            ...
            <p>Trouvez plus vite en complétant votre profil à 100%. &nbsp;<a href="/Users/Users/Profil">Editer</a></p>
    </div>
    <nav>
	    <ul class="menu-left">
	        
		    <li><a href="#" class="ep ">paramètre du compte<span></span></a></li>
            
                <li><a href="#" class="ep selected">gérer la demande<span></span></a></li>
        ...
        <h2>Mon profil</h2>
            <section class="profil" style="height:500px">
                <p>
                  Vous pouvez modifier, voir ou supprimer votre. Mieux vous connaître nous permet de cibler plus précisement votre besoin. Rassurez vous, vos données ne sont pas divulguées à des tiers sans votre consentement.
                </p><br><br>
                <div class="image1">
                
<img src="CSS/a.JPG">
<span style="position:relative; top:-68px"><a href="#">Voir</a></span>
<span style="position:relative; left:-30px; top:-48px"><a href="#">Modifier</a></span>
<span style="position:relative;top:-28px; left:-92px"><a href="#">Supprimer</a></span>

<img src="CSS/a.JPG">
<span style="position:relative; top:-68px;"><a href="#">Voir</a></span>
<span style="position:relative; left:-30px; top:-48px"><a href="#">Modifier</a></span>
<span style="position:relative; left:-85px; top:-28px"><a href="#">Suprimer</a></span>
<br>
<br><br>
...
<span style="position:relative; top:-68px;"><a href="#">Voir</a></span>
<span style="position:relative; left:-30px; top:-48px"><a href="#">Modifier</a></span>
<span style="position:relative; left:-90px; top:-28px"><a href="#">Suprimer</a></span>
<br><br><br>
