    ...
    <div class="wrapper background-smartbanner-ipad">
        <div class="txt-button">
            <p class="txt-grey txt-ipad">
                OPTIMISEZ VOTRE RECHERCHE AVEC<br/>
                NOTRE APPLICATION AVENDREALOUER
            </p>
...
<div class="search" style="position:relative; top:25px; height:100px">
    ...
    <div class="search-engine-list" style="display: none;">
        <ul class="type-select">
            <div class="col1">
                <li>
                    <a id="SearchEngineSale" class="selected buy" title="Achat">
                ...
                <li>
                    <a id="SearchEngineRent" class="rent" title="Location">
                        <span class="check"></span>
                ...
                <li>
                    <a id="SearchEngineNew" class="new" title="Neuf">
                        <span class="check"></span>
                ...
                <li>
                    <a id="SearchEngineLand" class="construct" title="Terrain">
                        <span class="check"></span>
                ...
                <li>
                    <a id="SearchEngineOffices" class="pro" title="Bureaux et Commerces">
                        <span class="check"></span>
                        <span class="label">BUREAUX ET COMMERCES</span>
                        <span class="arrow"></span>
                    </a>
                </li>
            </div>
...
<form action="http://www.avendrealouer.fr/RealEstate/Home/SearchSale" class="select-buy visible" data-ajax="true" data-ajax-complete="enableSubmit(&#39;#bt-searchsale&#39;)" data-ajax-mode="replace" data-ajax-update="#SearchEngine" id="form0" method="post" onSubmit="onSubmitAvalForm(this, &#39;#bt-searchsale&#39;)">    <div class="upper-block">
        <div class="search-input">
            <div class="newlocCtnr"></div>
            <div id="hp-placeholer">
                <span></span>
                <span>Quartier, ville, département, région</span>
            </div>
            <input autocomplete="off" class="place sale-rent" id="Criteria_LocalityLabel" name="Criteria.LocalityLabel" type="text" value="" placeholder="Où voulez vous habitez?"/>
    ...
    <div class="down-block">
        <div class="typeGroupCtnr">
            <select class="multi-select hp-buy-type hp-shadow-box" id="Criteria_TypeGroupIds" multiple="multiple" name="Criteria.TypeGroupIds"><option selected="selected" value="1">Appartement</option>
...
<option selected="selected" value="12">H&#244;tel Particulier</option>
<option selected="selected" value="98">Chambre d&#39;h&#244;tes</option>
<option value="105">Divers</option>
</select>
            <input data-val="true" data-val-number="Le champ SearchTypeID doit être un nombre." id="Criteria_SearchTypeID" name="Criteria.SearchTypeID" type="hidden" value="1" />
        </div>
        </div>
        ...
        <input id="SearchEngineTypeId" name="SearchEngineTypeId" type="hidden" value="1" />
</form>
<script src="../cdn2.avendrealouer.fr/Home/SearchEngine/sale609b.js?v=SoLV-5twRqrBpSLyi7mWQ6u4myGmk37abR2U4MgkZDs1"></script>
...
<div class="hp-container">
    <input id="SearchEngine_SearchEngineCriteria_DataContext_SeoRandomLocalityId" name="SearchEngine.SearchEngineCriteria.DataContext.SeoRandomLocalityId" type="hidden" value="3-42" />
