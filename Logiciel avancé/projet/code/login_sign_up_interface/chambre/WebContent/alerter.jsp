  ...
  <li class="sale">
                ...
                <li class="move">
                 <span class="menu-title" id="title_demenager" style="position:relative; left:45px; top:-5px"><a href="alerter.jsp"><img src="CSS/icon.png"><span class="pic"><span></span></span></span>
                      ...
                      <li class="move">
                 <span class="menu-title" id="title_demenager" style="font-size:20px"><a href="#">déconnexion</a><span class="pic"><span></span></span></span>
		...
		<div class="col-content">
			...
			<section>
				<p class="pre-checklist">
					La recherche 24H/24H. Recevez chaque jour vos alertes par email. Depuis cet espace vous pouvez créer, modifier et supprimer vos alertes immobilières.
			    </p>
				
				<div id="alertList">
					    <p>Vous n'avez pas encore crée d'alerte.</p>
        ...
        $('.checktrue,.checkfalse').click(function () {
            ...
            $.ajax({
                ...
                complete: function(data) {
                    if (!data) {
                        popError('Une erreur est survenue', 'Veuillez reéssayer ultérieurement', 2000);
                    } else {
                        popAlert('Informations', isChecked ? 'Votre alerte a été réactivée' : 'Votre alerte a été désactivée', 2000);
                    }
                },
            });
        });
