...
<input class="input-classic-grad mdp"  id="UserAuth_Password" maxlength="8" size="8"name="UserAuthPassword" placeholder="Mot de passe" type="password" />                    <div class="authError"></div>
                    <div class="btn-container">
                       
                        <input id="bt-auth" type="submit" class="validBtn" value="ME CONNECTER" onClick="pasuser(this.authentication)" style="position:relative; left:-100px; top:30px"/>
                    </div>
