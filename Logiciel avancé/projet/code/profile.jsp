...
<form method="post">                    <div class="col clear">
        ...
        <input list="civility" type="text" id="civil" placeholder="Vous êtes :">
...
<input class="input-classic onlynum" id="User_MobilePhone" maxlength="16" name="User.MobilePhone" placeholder="Téléphone" type="text" value="" />              <input class="input-classic name" id="User_TownName" maxlength="50" name="User.TownName" placeholder="Ville" type="text" value="" />                     
...
<div class="col-large">
                    ...
                    <div class="col clear">
                      <div id="User_ProfilsContainer">
                            <input list="proprietaire" type="text" id="choix" placeholder="Vous êtes :">
