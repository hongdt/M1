...
public class RulesPanel extends TTGSModule {
	...
	class ShowHideRulesPanel {
		...
		public JPanel AddJCB(int i,String rule) {
			...
			if(i>2 && i<11)
				jcbRule.setToolTipText("<html>Contraintes rigides par défaut& Contraintes souples</html>");
			if(i>10 && i<14)
				jcbRule.setToolTipText("<html>Contraintes optionnelles</html>");
			if(i>13 && i<16)
				jcbRule.setToolTipText("<html>Contraintes souples par défaut</html>");
